import { toSeasonId, getSeasonId, getSeasonLabel, MAX_SEASON_ID_LENGTH } from './seasonId';
...
describe('getSeasonId', () => {
  ...
  it('cae al año en una edición sin identificador', () => {
    // Es el caso de las ediciones anteriores a esta feature: su archivo está en
    // `results/{año}` y hay que seguir encontrándolo.
...
describe('getSeasonLabel', () => {
  it('prefiere el nombre de la edición', () => {
    expect(getSeasonLabel({ name: 'The Game Awards 2026', season: 2026 })).toBe('The Game Awards 2026');
