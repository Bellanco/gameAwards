...
export const en = {
  ...
  season: "Season",
  seasonDescription: "Set the edition schedule (opening, closing and results publication) and manage the yearly reset.",
  currentSeason: "Current season",
  openVoting: "Follow the schedule",
  closeVoting: "Close now",
  saved: "Saved",
  votingSchedule: "Voting schedule",
  votingScheduleHelp: "Pick the three days of the edition. Opening starts at 00:00 that day; closing and results publication happen at 23:59 (Spanish mainland time). Leave a field empty and save to remove that date: with no opening date voting is already open, with no closing date it never closes on its own, and with no results date nothing is published. Saving a future opening date while voting is manually closed hands control back to the schedule.",
  opensOnLabel: "Opens",
  closesOnLabel: "Closes",
  resultsOnLabel: "Results",
  saveSchedule: "Save schedule",
  testPreset: "Quick test: today / +7 / +14 days",
  testPresetHelp: "Fills in the three dates so you can try a full edition without waiting for December. Review them and press Save schedule.",
  closesOn: "Closes on",
  opensOn: "Opens on",
  resultsOn: "Results on",
  noOpeningDate: "No opening date (already open)",
  noClosingDate: "No closing date (closes manually only)",
  noResultsDate: "No results date (nothing is published)",
  votingScheduled: "Voting scheduled",
  forcedClosed: "Closed manually by the admin",
  errorCloseBeforeOpen: "The closing date cannot be earlier than the opening date.",
  errorResultsBeforeClose: "Results cannot be published before voting closes.",
  resultsPublication: "Results publication",
  resultsPublicationHelp: "Saving the schedule also prepares the results snapshot (winners and standings) everyone will see on the chosen day. If you change winners afterwards, refresh it here.",
  publishResultsNow: "Refresh results now",
  resultsUpdated: "Results updated",
  resultsPublishedAlready: "Results published",
  resultsPendingPublication: "Pending publication",
  ...
  archived: "Archived",
  history: "History",
  historyDescription: "Winners and standings for every published edition.",
  // Edition identity (Admin)
  seasonIdentity: "Edition name",
  seasonIdentityHelp: "Name this edition so you can tell it apart in the history. The identifier is its archive key: change it if you want a new edition in the same year (for example, \"2026-summer\") instead of overwriting the previous one.",
  seasonNameLabel: "Name",
  seasonNamePlaceholder: "The Game Awards 2026",
  seasonIdLabel: "Identifier",
  seasonIdHelp: "Letters, numbers and hyphens. Used as the key of the results archive.",
