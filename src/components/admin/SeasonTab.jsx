    ...
    <div className="flex flex-col gap-1">
      <label className="text-sm font-semibold theme-text-secondary">
        ...
        <input
          ...
          disabled={disabled}
          className="mt-1 block w-full min-h-[44px] px-4 py-2.5 theme-container-secondary theme-border-control border rounded-sm theme-text-primary focus:outline-hidden focus:border-(--color-accent) focus-visible:ring-2 focus-visible:ring-(--color-accent)/40"
        />
      </label>
