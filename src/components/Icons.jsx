...
export function MedalSilverIcon({ className = "w-8 h-8" }) {
  return (
    <svg aria-hidden="true" className={className} viewBox="0 0 24 24" fill="currentColor" opacity="0.8">
...
export function MedalBronzeIcon({ className = "w-8 h-8" }) {
  return (
    <svg aria-hidden="true" className={className} viewBox="0 0 24 24" fill="currentColor" opacity="0.7">
      <circle cx="12" cy="10" r="4" />
      <path d="M12 2a8 8 0 100 16 8 8 0 000-16zm0 14a6 6 0 110-12 6 6 0 010 12z" />
    </svg>
  );
